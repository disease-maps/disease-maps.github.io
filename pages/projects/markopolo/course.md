...
**Part 3. ExposomeMap-PM.** Developing specific pathways for extending the ExposomeMap-PM resource. Deliverables: pathway diagrams in CellDesigner and MINERVA, tables with map entities and identifiiers automatically exported from MINERVA, brief textual descriptions with supporting references.
